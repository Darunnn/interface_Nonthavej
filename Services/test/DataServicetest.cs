        ...
        private PrescriptionBodyRequest BuildPrescriptionBody(IDataReader reader)
        {
            try
            {
                ...
                return new PrescriptionBodyRequest
                {
                    ...
                    f_dosage = decimal.TryParse(reader["f_dosevalue"]?.ToString(), out decimal dosage) ? dosage : null,
                    f_dosageunit = ToNull(reader["f_dosageunit"]?.ToString()),
                    f_dosagetext = ToNull(reader["f_dosage"]?.ToString()),
                    f_drugformcode = null,
                    f_drugformdesc = null,
                    ...
                    f_status = ToNull(reader["f_ordertype"]?.ToString()),
